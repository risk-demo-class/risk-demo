...
class RiskCheckRequest(BaseModel):
    """风险检查请求"""
    event_type: Literal["旅游下单", "机票预订", "酒店预订", "签证申请", "支付", "售后申请", "投诉", "出行前核验"]
...
class RuleCreate(BaseModel):
    ...
    rule_category: Literal["旅游订单风险", "机票风险", "酒店风险", "签证风险", "支付风险", "售后滥用", "投诉风险", "账户风险", "目的地风险"]
    event_type: Literal["旅游下单", "机票预订", "酒店预订", "签证申请", "支付", "售后申请", "投诉", "出行前核验", "通用"] = "通用"
    rule_condition: dict
...
class RuleUpdate(BaseModel):
    ...
    rule_category: Optional[Literal["旅游订单风险", "机票风险", "酒店风险", "签证风险", "支付风险", "售后滥用", "投诉风险", "账户风险", "目的地风险"]] = None
    event_type: Optional[Literal["旅游下单", "机票预订", "酒店预订", "签证申请", "支付", "售后申请", "投诉", "出行前核验", "通用"]] = None
...
class BlacklistCreate(BaseModel):
    """添加黑名单请求"""
    blacklist_type: Literal["用户", "手机号", "护照号", "身份证号", "支付账号", "设备指纹", "IP", "订单"]
    blacklist_value: str
