...
FEATURE_COLUMNS: list[str] = [
    "sender_total_shipments", "sender_shipments_30d", "sender_shipments_7d",
    "sender_shipments_1h", "sender_night_shipments_30d",
    "sender_cross_border_count_90d", "sender_dangerous_item_hits_90d",
    "sender_cod_shipments_90d", "sender_cod_refuse_count_90d",
    "sender_cod_refuse_rate_90d", "sender_receiver_count_30d",
    "sender_address_count_30d", "sender_device_user_count_30d",
    "sender_account_age_days", "shipment_actual_weight",
    "shipment_declared_weight_diff_rate", "shipment_declared_value",
    "shipment_item_category_count", "shipment_dangerous_flag",
    "shipment_declaration_mismatch", "shipment_cod_amount",
    "shipment_is_cross_border", "address_user_count_30d", "address_is_new",
    "address_is_remote_or_temporary",
]
