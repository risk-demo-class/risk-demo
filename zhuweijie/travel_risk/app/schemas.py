...
class RiskCheckRequest(BaseModel):
    """风险检查请求"""
    event_type: Literal["机票预订", "酒店预订", "签证申请", "跟团游预订"]
...
class RuleCreate(BaseModel):
    ...
    rule_category: Literal["机票囤积", "酒店滥用", "签证欺诈", "账户风险", "支付风险", "行程风险"]
    event_type: Literal["机票预订", "酒店预订", "签证申请", "跟团游预订", "通用"] = "通用"
    rule_condition: dict
...
class RuleUpdate(BaseModel):
    ...
    rule_category: Optional[Literal["机票囤积", "酒店滥用", "签证欺诈", "账户风险", "支付风险", "行程风险"]] = None
    event_type: Optional[Literal["机票预订", "酒店预订", "签证申请", "跟团游预订", "通用"]] = None
...
class BlacklistCreate(BaseModel):
    """添加黑名单请求"""
    blacklist_type: Literal["用户", "护照号", "设备指纹", "支付账号"]
    blacklist_value: str
