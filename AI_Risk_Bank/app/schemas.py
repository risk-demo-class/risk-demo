...
class RiskCheckRequest(BaseModel):
    """风险检查请求"""
    event_type: Literal["信用卡申请", "贷款申请", "大额转账", "异常登录"]
...
class RuleCreate(BaseModel):
    ...
    rule_category: Literal["账户安全", "交易反欺诈", "信贷风险", "设备风险", "渠道风险", "黑名单"]
    event_type: Literal["信用卡申请", "贷款申请", "大额转账", "异常登录", "通用"] = "通用"
    rule_condition: dict
...
class RuleUpdate(BaseModel):
    ...
    rule_category: Optional[Literal["账户安全", "交易反欺诈", "信贷风险", "设备风险", "渠道风险", "黑名单"]] = None
    event_type: Optional[Literal["信用卡申请", "贷款申请", "大额转账", "异常登录", "通用"]] = None
...
if __name__ == "__main__":
    ...
    req = RiskCheckRequest(
        event_type="信用卡申请", source_id="ord_demo_001", user_id="U0001",
    ...
    detail = AssessmentDetailResponse(
        assessment_id="ast_demo_xxx", event_id="evt_demo_xxx",
        user_id="U0001", event_type="信用卡申请", event_source_id="ord_demo_001",
