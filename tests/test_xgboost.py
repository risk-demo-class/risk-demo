...
class TestFeatureColumns:
    ...
    def test_feature_prefixes(self):
        """12 user_* + 10 order_* + 3 addr_* (制造业 align with feature.py naming)"""
    ...
    def test_features_to_array(self):
        ...
        features = {
            ...
            "addr_is_new_region": 0,         # 24 (last in FEATURE_COLUMNS)
        }
    ...
    def test_feature_columns_align_with_feature_module(self):
        ...
        """
        # 12 user + 10 order + 3 addr, aligned with feature.py's 3 feat_funcs dict order
        expected = [
            ...
            "order_msrp_ratio",
            "order_is_night",
            "order_ship_region_match",
            "order_sn_repair_count_90d",
            "order_report_count",
            "order_repair_cost_ratio",
            "order_is_out_of_warranty",
            # --- 3 addr features (compute_address_features) ---
            "addr_region_total",
            "addr_region_cross_count",
            "addr_is_new_region",
        ]
...
class TestModelLoad:
    ...
    def test_load_real_model(self, capsys):
        ...
        normal_features = {
            ...
            "user_dealer_contract_expired": 0,
            "user_cancel_count": 0,
            "user_report_count": 0,
            "order_total_amount": 200.0,
            "order_quantity": 1,
            "order_unit_price": 200.0,
            "order_msrp_ratio": 0.9,
            "order_is_night": 0,
            "order_ship_region_match": 1,
            "order_sn_repair_count_90d": 0,
            "order_report_count": 0,
            "order_repair_cost_ratio": 0.0,
            "order_is_out_of_warranty": 0,
            "addr_region_total": 1,
            "addr_region_cross_count": 0,
            "addr_is_new_region": 0,
        }
        ...
        risky_features.update({
            ...
            "user_orders_30d": 80,
            "user_total_amount": 8000000.0,
            "user_warranty_count": 150,
            "user_warranty_rate": 0.95,
            "user_report_count": 10,
            "order_sn_repair_count_90d": 3,
            "order_report_count": 4,
        })
...
class TestPredict:
    ...
    def test_predict_normal_user(self):
        ...
        normal.update({
            ...
            "user_orders_30d": 2,
            "user_orders_7d": 1,
            "user_total_amount": 2000000,
            "user_avg_order_amount": 400000,
            "user_max_order_amount": 900000,
            "user_warranty_count": 1,
            "user_repair_count": 0,
            "user_warranty_rate": 0.2,
            "user_dealer_contract_expired": 0,
            "user_cancel_count": 0,
            "user_report_count": 0,
            "order_total_amount": 400000,
            "order_quantity": 4,
            "order_unit_price": 100000,
            "order_msrp_ratio": 0.88,
            "order_is_night": 0,
            "order_ship_region_match": 1,
            "order_sn_repair_count_90d": 0,
            "order_report_count": 0,
            "order_repair_cost_ratio": 0.1,
            "order_is_out_of_warranty": 0,
            "addr_region_total": 1,
            "addr_region_cross_count": 0,
            "addr_is_new_region": 0,
    ...
    def test_predict_risky_user(self):
        ...
        from app.engine.ml_model import FEATURE_COLUMNS
        # 高风险经销商: 25 维全部填, 高保修率/套保/串货/跨区/大单
        risky = {
            # 用户画像 (高保修率 + 多维修 + 被举报)
            "user_total_orders": 200,
            "user_orders_30d": 100,
            ...
            "user_repair_count": 120,
            "user_warranty_rate": 0.9,
            "user_dealer_contract_expired": 0,
            "user_cancel_count": 50,
            "user_report_count": 30,          # 被举报 30 次
            # 订单特征 (大额 + 套保 + 跨区 + 出保)
            "order_total_amount": 500000,
            "order_quantity": 5,
            "order_unit_price": 100000,
            "order_msrp_ratio": 0.95,
            "order_is_night": 1,              # 凌晨下单
            "order_ship_region_match": 0,     # 跨区
            "order_sn_repair_count_90d": 3,   # 同一 SN 90 天 3 次维修
            "order_report_count": 5,          # 被举报 5 次
            "order_repair_cost_ratio": 0.7,   # 维修费 > MSRP 60%
            "order_is_out_of_warranty": 1,    # 已出保
            # 区域特征
            "addr_region_total": 8,
            "addr_region_cross_count": 5,     # 跨区 5 单
            "addr_is_new_region": 1,          # 新区域
        }
