...
if __name__ == "__main__":
    ...
    rules = [
        _MockRule("R001", {"field": "event_amount", "op": ">=", "value": 50000}, 70, "高", "人工审核", 80),
        _MockRule("R002", {"field": "event_amount", "op": ">=", "value": 100000}, 95, "极高", "拒绝", 100),
        _MockRule("R003", {"field": "event_geo_mismatch", "op": "==", "value": 1}, 60, "高", "人工审核", 70),
    ]
    # 高风险转账特征: 大额 + 异地
    feats = {"event_amount": 150000, "event_geo_mismatch": 1, "user_transaction_count_30d": 5}
