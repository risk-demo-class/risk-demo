...
class Settings(BaseSettings):
    ...
    # 银行四场景阈值：涉及资金出账的转账最严格，登录以标记和审核为主。
    ...
    BUSINESS_EVENT_TYPES: tuple[str, ...] = ("信用卡", "贷款", "转账", "登录")
    BLACKLIST_TYPES: tuple[str, ...] = ("用户", "设备指纹", "IP", "银行卡号", "身份证号")
    ...
    XGB_TRAIN_DATA_LIMIT: int = 1000  # 教学模拟只取最近 1000 条 (按 create_time DESC)
...
if __name__ == "__main__":
    print("=" * 60)
    print("Bank AI_Risk 全局配置 (从 .env 加载, 缺省值兜底)")
    print("=" * 60)
