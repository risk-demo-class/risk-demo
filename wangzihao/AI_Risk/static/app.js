/**
 * 制造业设备经销商智能风控平台 - 公共前端工具函数
 */

// 核心数据库继续保存冻结的兼容码；这里只负责制造业展示翻译。
...
const RULE_CATEGORY_DISPLAY_NAMES = {
    '订单欺诈': '经销商采购风险',
    '支付风险': '异常采购/付款风险',
    '账户风险': '经销商主体风险',
    '售后滥用': '设备保修欺诈',
...
const BLACKLIST_TYPE_DISPLAY_NAMES = {
    '用户': '经销商',
    '地址': '区域',
    '手机号': '联系电话',
};

function displayEventType(value) { return EVENT_DISPLAY_NAMES[value] || value || '-'; }
function displayRuleCategory(value) { return RULE_CATEGORY_DISPLAY_NAMES[value] || value || '-'; }
function displayBlacklistType(value) { return BLACKLIST_TYPE_DISPLAY_NAMES[value] || value || '-'; }
