...
# 固定 25 维特征顺序 (旅游版, 训练和推理都用这个顺序, 防 dict 顺序不一致导致特征错位)
...
if __name__ == "__main__":
    ...
    sample = {
        ...
        "user_visa_reject_90d": 0, "user_visa_countries_30d": 1,
        "user_account_age_days": 300, "user_real_name_status": 1,
        "user_refund_rate": 0.0,
        "order_total_amount": 1500, "order_is_night": 0,
        "order_trip_days": 7, "order_passenger_count": 1,
        "order_is_overseas": 1, "order_is_flight": 1,
        "order_booking_count": 2, "order_is_urgent": 0,
        "trip_passenger_match_rate": 1.0, "trip_blacklist_passport_count": 0,
        "trip_same_flight_1h": 1, "trip_distinct_passenger_count": 1,
        "trip_visa_apply_30d": 1, "trip_same_hotel_1h": 0,
    }
