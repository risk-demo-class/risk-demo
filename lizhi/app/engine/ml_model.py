...
# 【任务3 旅游行业】特征名与 feature.py 三大特征族一一对应:
#   用户族 (14) / 订单族 (8) / 目的地族 (3, 原"地址"族映射)
# 改这个列表前必须同步 feature.py::compute_*_features, 对不齐会让 XGBoost
# 训练/推理退化成 0 填充, 业务上相当于模型没工作
FEATURE_COLUMNS: list[str] = [
    ...
    "user_refund_count",
    "user_refund_rate",
    "user_night_order_count",
    "user_same_flight_1h_count",
    "user_visa_apply_count",
    "user_visa_reject_count",
    "user_visa_multi_country_30d",
    "user_account_age_days",
    "order_total_amount",
    "order_passenger_count",
    "order_is_night",
    "order_days_to_depart",
    "order_trip_days",
    "order_is_international",
    "order_same_flight_1h_count",
    "order_new_passenger_rate",
    "addr_dest_country_count",
    "addr_international_order_rate",
    "addr_current_dest_used_before",
]
...
if __name__ == "__main__":
    ...
    sample = {
        "user_total_orders": 3, "user_orders_30d": 1,
        "user_total_amount": 5000, "user_avg_order_amount": 1666.67,
        "user_max_order_amount": 3000,
        "user_cancel_count": 0, "user_refund_count": 0, "user_refund_rate": 0.0,
        "user_night_order_count": 0, "user_same_flight_1h_count": 1,
        "user_visa_apply_count": 0, "user_visa_reject_count": 0,
        "user_visa_multi_country_30d": 0, "user_account_age_days": 365,
        "order_total_amount": 1500, "order_passenger_count": 1,
        "order_is_night": 0, "order_days_to_depart": 15, "order_trip_days": 5,
        "order_is_international": 0, "order_same_flight_1h_count": 1,
        "order_new_passenger_rate": 0.0,
        "addr_dest_country_count": 1, "addr_international_order_rate": 0.0,
        "addr_current_dest_used_before": 1,
    }
