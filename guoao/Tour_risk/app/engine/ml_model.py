...
# 改这个列表前必须同步: feature.py::compute_user_features / compute_shipment_features
# / compute_address_features, 对不齐会让 XGBoost 训练/推理退化成 0 填充
FEATURE_COLUMNS: list[str] = [
    ...
    "user_shipment_30d",
    "user_cod_count",
    "user_cod_reject_rate",
    "user_dangerous_count",
    "user_undeclared_count",
    "user_real_name_status",
    "user_account_age_days",
    "user_address_count",
    "user_cross_province_count",
    ...
    "shipment_weight_kg",
    "shipment_item_count",
    "shipment_dangerous_flag",
    "shipment_undeclared_flag",
    "shipment_declared_value",
    "shipment_cod_amount",
    "shipment_is_cross_border",
    "shipment_is_night",
    # 地址族 (3)
    "addr_total_count",
    "addr_province_count",
...
if __name__ == "__main__":
    ...
    sample = {
        "user_shipment_count": 3, "user_shipment_7d": 1, "user_shipment_30d": 2,
        "user_cod_count": 1, "user_cod_reject_rate": 0.0,
        "user_dangerous_count": 0, "user_undeclared_count": 0,
        "user_real_name_status": 1, "user_account_age_days": 180,
        "user_address_count": 2, "user_cross_province_count": 1,
        "user_avg_declared_value": 800.0, "user_avg_weight": 3.5,
        "user_cancel_count": 0,
        "shipment_weight_kg": 5.0, "shipment_item_count": 2,
        "shipment_dangerous_flag": 0, "shipment_undeclared_flag": 0,
        "shipment_declared_value": 1500, "shipment_cod_amount": 0,
        "shipment_is_cross_border": 0, "shipment_is_night": 0,
