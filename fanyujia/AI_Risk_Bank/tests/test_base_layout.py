...
class TestBaseLayout:
    ...
    def test_sidebar_html_structure(self, base_html):
        ...
        # 7 个 nav-link
        actual_count = nav_html.count('class="nav-link')
        assert actual_count == 7, f"侧边栏应有 7 个 nav-link, 实际 {actual_count}"
        # 关键页面
    ...
    def test_main_content_html_structure(self, base_html):
        ...
        ), "主内容区应保留 col-md-10 main-content class"
        assert 'role="main"' in base_html, "主内容区应提供 main landmark"
