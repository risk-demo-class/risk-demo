...
FEATURE_COLUMNS: list[str] = [
    "user_txn_count_1h", "user_txn_count_24h", "user_txn_amount_24h",
    "user_avg_txn_amount_30d", "user_max_txn_amount_30d", "user_login_fail_count_1h",
    "user_distinct_devices_30d", "user_distinct_ips_24h", "user_new_device_flag",
    "user_geo_jump", "user_credit_score", "user_debt_ratio",
    "user_loan_apply_count_30d", "user_account_age_days", "txn_amount",
    "txn_hour", "txn_is_night", "txn_is_cross_geo", "txn_is_new_payee",
    "txn_count_to_payee_1h", "txn_distinct_source_cards_1h", "txn_channel_risk",
    "device_linked_user_count", "ip_is_proxy", "ip_is_tor",
]
