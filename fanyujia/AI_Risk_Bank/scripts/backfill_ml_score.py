        ...
        for i, (aid, eid, uid, dec) in enumerate(rows, 1):
            try:
                async with SessionLocal() as db:
                    # Use the persisted bank feature snapshot for this event.
                    # Recomputing here would call the legacy ecommerce feature
                    # pipeline and produce a mismatched 25-column vector.
                    ...
                    features = {name: float(value) for name, value in feature_rows}
