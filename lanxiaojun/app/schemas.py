"""Pydantic 请求/响应模型: API 端点的数据校验和序列化 (教育版)"""
...
class RiskCheckResponse(BaseModel):
    ...
    # 被哪种黑名单撞了: None=没撞黑, "用户"/"学号"/"身份证"/"设备指纹"/"支付账号"/"手机号"
...
class RuleUpdate(BaseModel):
    ...
    rule_category: Optional[Literal["注册风险", "账号风险", "营销作弊", "刷课行为",
                                    "退费欺诈", "支付风险", "内容安全", "师资风险"]] = None
    event_type: Optional[Literal["register", "login", "real_name_auth", "purchase",
                                 "coupon_claim", "course_watch", "refund_apply",
                                 "complaint", "通用"]] = None
...
class BlacklistCreate(BaseModel):
    """添加黑名单请求"""
    blacklist_type: Literal["用户", "手机号", "学号", "身份证", "设备指纹", "支付账号"]
    blacklist_value: str
