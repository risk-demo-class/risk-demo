...
--
-- 方式2: 手动按顺序执行 (在项目根目录下)
--   mysql -u root -p1234 --default-character-set=utf8mb4 ecs < sql/init_business_tables.sql
--   mysql -u root -p1234 --default-character-set=utf8mb4 ecs < sql/init_business_data.sql
--   mysql -u root -p1234 --default-character-set=utf8mb4 ecs < sql/init_risk_tables.sql
--   mysql -u root -p1234 --default-character-set=utf8mb4 ecs < sql/init_risk_data.sql
--
-- 方式3: 仅创建数据库结构 (不含数据)
--   mysql -u root -p1234 --default-character-set=utf8mb4 ecs < sql/init_business_tables.sql
--   mysql -u root -p1234 --default-character-set=utf8mb4 ecs < sql/init_risk_tables.sql
...
--      mysql -u root -p1234 ecs < sql/migration_add_2026_08_07_fields.sql
...
--      mysql -u root -p1234 ecs < sql/migration_add_p4_tables.sql
