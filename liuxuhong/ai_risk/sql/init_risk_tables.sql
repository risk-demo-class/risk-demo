...
CREATE TABLE IF NOT EXISTS `risk_rule` (
    ...
    `rule_category` ENUM('报名欺诈','退费滥用','账户风险','认证欺诈','打赏风险','综合风险') NOT NULL COMMENT '风险场景分类',
    `event_type` ENUM('课程报名','退费申请','学历认证','直播打赏','通用') NOT NULL DEFAULT '通用' COMMENT '适用事件类型',
...
CREATE TABLE IF NOT EXISTS `risk_event` (
    ...
    `event_type` ENUM('课程报名','退费申请','学历认证','直播打赏') NOT NULL COMMENT '事件类型',
...
CREATE TABLE IF NOT EXISTS `risk_case` (
    ...
    `event_type` ENUM('课程报名','退费申请','学历认证','直播打赏') DEFAULT NULL COMMENT '触发案件的事件类型',
...
CREATE TABLE IF NOT EXISTS `risk_blacklist` (
    ...
    `blacklist_type` ENUM('用户','学号','身份证','设备指纹','直播账号') NOT NULL COMMENT '黑名单类型',
