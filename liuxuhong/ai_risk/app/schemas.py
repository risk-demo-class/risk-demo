...
class RiskCheckRequest(BaseModel):
    """风险检查请求"""
    event_type: Literal["课程报名", "退费申请", "学历认证", "直播打赏"]
...
class RuleCreate(BaseModel):
    ...
    rule_category: Literal["报名欺诈", "退费滥用", "账户风险", "认证欺诈", "打赏风险", "综合风险"]
    event_type: Literal["课程报名", "退费申请", "学历认证", "直播打赏", "通用"] = "通用"
    rule_condition: dict
...
class RuleUpdate(BaseModel):
    ...
    rule_category: Optional[Literal["报名欺诈", "退费滥用", "账户风险", "认证欺诈", "打赏风险", "综合风险"]] = None
    event_type: Optional[Literal["课程报名", "退费申请", "学历认证", "直播打赏", "通用"]] = None
...
class BlacklistCreate(BaseModel):
    """添加黑名单请求"""
    blacklist_type: Literal["用户", "学号", "身份证", "设备指纹", "直播账号"]
    blacklist_value: str
