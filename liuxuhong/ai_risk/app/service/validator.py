...
# 业务语义:
#   - 课程报名: source_id = order_id (报名订单)
#   - 退费申请: source_id = refund_id (退费申请单)
#   - 学历认证: source_id = user_id (认证对象是用户本人)
#   - 直播打赏: source_id = user_id (打赏账号)
_EVENT_SOURCE_VALIDATORS = {
    ("课程报名",): (OrderInfo, "order_id", None, "报名订单", 400),
    ("退费申请",): (RefundRequest, "refund_id", None, "退费申请", 400),
    ("学历认证", "直播打赏"): (UserInfo, "user_id", None, "用户", 400),
}
