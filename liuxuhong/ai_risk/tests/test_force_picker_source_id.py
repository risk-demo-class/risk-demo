...
【2026-08-12 电商→教育改造】此测试锁定电商遗留脚本 gen_risk_data_with_dates.py
  + 已删除的 logistics_complaints_record 表. 教育版用 gen_train_dataset.py 替代,
  不再有物流投诉/售后 postsale 路径, 整个测试标记 skip (保留历史记录).
"""
import re
...
pytestmark = pytest.mark.skip(
    reason="电商遗留脚本 gen_risk_data_with_dates.py 已被教育版 gen_train_dataset.py 替代",
)
