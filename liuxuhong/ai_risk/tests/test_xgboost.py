...
class TestFeatureColumns:
    ...
    def test_features_to_array(self):
        ...
        features = {
            "user_total_enrollments": 10,    # 0
            "user_enrollments_30d": 3,       # 1
            # intentionally omit 22 middle keys -> 0
            "addr_is_new_device": 0,         # 24 (last in FEATURE_COLUMNS)
        }
    ...
    def test_feature_columns_align_with_feature_module(self):
        ...
        expected = [
            ...
            "user_total_enrollments",
            "user_enrollments_30d",
            "user_enrollments_7d",
            "user_total_amount",
            "user_avg_course_amount",
            "user_max_course_amount",
            "user_refund_count",
            "user_refund_rate",
            "user_refund_amount",
            "user_total_study_minutes",
            "user_avg_completion_rate",
            "user_cancel_count",
            "user_device_count",
            "user_course_category_count",
            # --- 8 order features (compute_order_features) ---
            "order_total_amount",
            "order_course_count",
            "order_is_first_course",
            "order_discount_amount",
            "order_discount_rate",
            "order_enroll_hour",
            "order_study_goal_length",
            "order_expected_days",
            # --- 3 addr/device features (compute_address_features) ---
            "addr_device_count",
            "addr_ip_count",
            "addr_is_new_device",
        ]
...
class TestModelLoad:
    ...
    def test_load_real_model(self, capsys):
        ...
        normal_features = {
            "user_total_enrollments": 2,
            "user_enrollments_30d": 1,
            "user_enrollments_7d": 0,
            "user_total_amount": 2000.0,
            "user_avg_course_amount": 1000.0,
            "user_max_course_amount": 1500.0,
            "user_refund_count": 0,
            "user_refund_rate": 0.0,
            "user_refund_amount": 0,
            "user_total_study_minutes": 5000,
            "user_avg_completion_rate": 0.8,
            "user_cancel_count": 0,
            "user_device_count": 1,
            "user_course_category_count": 1,
            "order_total_amount": 2000.0,
            "order_course_count": 1,
            "order_is_first_course": 0,
            "order_discount_amount": 0,
            "order_discount_rate": 0.0,
            "order_enroll_hour": 10,
            "order_study_goal_length": 20,
            "order_expected_days": 90,
            "addr_device_count": 1,
            "addr_ip_count": 1,
            "addr_is_new_device": 0,
        }
        # 3. 准备一组"高风险用户"特征 (强信号, 期望 → 人工审核/拒绝)
        risky_features = dict(normal_features)
        risky_features.update({
            "user_total_enrollments": 200,
            "user_enrollments_30d": 80,
            "user_enrollments_7d": 40,
            "user_total_amount": 80000.0,
            "user_refund_count": 150,
            "user_refund_rate": 0.95,
            "user_total_study_minutes": 50,
            "user_avg_completion_rate": 0.01,
            "user_device_count": 8,
        })
...
class TestPredict:
    ...
    def test_predict_risky_user(self):
        ...
        # 高风险用户: 25 维全部填, 高频报名/高退费率/0学时/多设备
        risky = {
            # 用户画像 (高频报名 + 高退费 + 0学时)
            "user_total_enrollments": 200,
            "user_enrollments_30d": 100,
            "user_enrollments_7d": 50,
            "user_total_amount": 800000,       # 80w 累计
            "user_avg_course_amount": 4000,
            "user_max_course_amount": 50000,
            "user_refund_count": 180,         # 90% 退费率
            "user_refund_rate": 0.9,
            "user_refund_amount": 700000,
            "user_total_study_minutes": 30,   # 0学时 (几乎没学)
            "user_avg_completion_rate": 0.01,
            "user_cancel_count": 50,
            "user_device_count": 8,           # 多设备 (可疑)
            "user_course_category_count": 5,
            # 订单特征
            "order_total_amount": 50000,
            "order_course_count": 1,
            "order_is_first_course": 1,
            "order_discount_amount": 49000,
            "order_discount_rate": 0.02,
            "order_enroll_hour": 3,           # 凌晨报名
            "order_study_goal_length": 2,     # 学习目标极短 (假目标)
            "order_expected_days": 1,
            # 设备特征
            "addr_device_count": 8,
            "addr_ip_count": 6,               # 多IP
            "addr_is_new_device": 1,
        }
