...
__all__ = [
    # 业务表 (17)
    "UserInfo", "EnterpriseInfo", "BankAccount", "LoanApplication", "LoanContract",
    "RepaymentPlan", "RepaymentRecord", "CreditReport", "IncomeVerify", "Collateral",
    "Guarantee", "Transaction", "LoginLog", "DeviceFingerprint", "IpGeoLocation",
    "BlacklistExtra", "UserRelation",
    # 风控表 (9 = 7 原 + 2 系统管理, P4 新增)
...
if __name__ == "__main__":
    ...
    for i, name in enumerate(business_models, 1):
        ...
        print(f"  {i:>2}. {name:<30} {len(cols)} 字段  PK={list(cls.__table__.primary_key.columns.keys())}")
