...
包含 7 张行业业务表 + 9 张风控表 (核心 9 表完全复用) 的 SQLAlchemy 2.x 映射
"""
...
if __name__ == "__main__":
    ...
    business_models = ["UserInfo", "Product", "DealerInfo", "OrderInfo", "WarrantyRecord", "CrossRegionReport", "BlacklistExtra"]
    risk_models = [
        "RiskRule", "RiskEvent", "RiskFeature", "RiskAssessment",
        "RiskCase", "RiskBlacklist", "RiskUserProfile",
