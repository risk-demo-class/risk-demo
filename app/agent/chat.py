...
1. **风险检查**: 对指定患者/诊疗事件 (挂号/处方开具/医保结算/药品下单) 执行实时风控评估
2. **案件管理**: 查询和分析待审核/已处理的风控案件 (医保欺诈/处方违规/挂号黄牛/药品代购)
3. **患者画像**: 查看患者的风险评分、就诊行为特征、历史记录
4. **黑名单管理**: 查询、添加、移除黑名单 (用户/医保卡号/身份证号/医生执业证/医院编码)
5. **数据分析**: 统计仪表盘、趋势分析、规则命中效果
6. **业务查询**: 查看挂号、处方、医保结算、药品订单等业务数据
