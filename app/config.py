...
# ============================================================
# 制造业业务常量 (行业改写 - 场景 D: 经销商订货/设备保修/采购订单/售后维修)
# 与 app/schemas.py / app/models_risk.py / sql/*.sql 保持一致, 改这里要同步三处
# ============================================================

# 业务事件类型 (risk_event.event_type / risk_rule.event_type / risk_case.event_type)
BUSINESS_EVENT_TYPES: list[str] = ["经销商订货", "采购订单", "保修申请", "售后维修", "串货举报"]

# 规则分类 (risk_rule.rule_category)
BUSINESS_RULE_CATEGORIES: list[str] = ["串货风险", "订货欺诈", "保修滥用", "维修欺诈", "经销商资质", "区域风险"]

# 黑名单类型: 用户 走核心表 risk_blacklist, 经销商/设备SN/维修工 走行业业务表 blacklist_extra
BLACKLIST_TYPES: list[str] = ["用户", "经销商", "设备SN", "维修工"]
CORE_BLACKLIST_TYPE: str = "用户"
EXTRA_BLACKLIST_TYPES: list[str] = ["经销商", "设备SN", "维修工"]

# Pydantic Literal 类型别名 (schemas.py 直接引用)
EventType = Literal["经销商订货", "采购订单", "保修申请", "售后维修", "串货举报"]
RuleEventType = Literal["经销商订货", "采购订单", "保修申请", "售后维修", "串货举报", "通用"]
RuleCategory = Literal["串货风险", "订货欺诈", "保修滥用", "维修欺诈", "经销商资质", "区域风险"]
BlacklistType = Literal["用户", "经销商", "设备SN", "维修工"]
