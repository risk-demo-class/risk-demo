...
class RiskCheckRequest(BaseModel):
    """风险检查请求"""
    event_type: Literal["课程报名", "退费申请", "直播打赏"]
...
class RuleCreate(BaseModel):
    ...
    rule_category: Literal["报名欺诈", "退费滥用", "账号风险", "直播风险"]
    event_type: Literal["课程报名", "退费申请", "直播打赏", "通用"] = "通用"
    rule_condition: dict
...
class RuleUpdate(BaseModel):
    ...
    rule_category: Optional[Literal["报名欺诈", "退费滥用", "账号风险", "直播风险"]] = None
    event_type: Optional[Literal["课程报名", "退费申请", "直播打赏", "通用"]] = None
...
class BlacklistCreate(BaseModel):
    """添加黑名单请求"""
    blacklist_type: Literal["用户", "学号", "设备指纹"]
    blacklist_value: str
