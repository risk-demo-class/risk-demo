...
if __name__ == "__main__":
    ...
    test_cases = [
        ...
        ]}, {"user_total_parcel_count": 0}, True),
        ("AND 失败",        {"and": [
            {"field": "x", "op": ">", "value": 5},
            {"field": "y", "op": ">", "value": 5},
        ]}, {"x": 10, "y": 1}, False),
    ...
    rules = [
        _MockRule("R001", {"field": "order_declared_value", "op": ">=", "value": 5000}, 70, "高", "人工审核", 80),
        _MockRule("R002", {"field": "order_declared_value", "op": ">=", "value": 10000}, 95, "极高", "拒绝", 100),
        _MockRule("R003", {"field": "user_cod_overdue_count", "op": ">=", "value": 1}, 60, "高", "人工审核", 70),
    ]
    # 高风险用户特征: 大额申报 + COD 逾期
    feats = {"order_declared_value": 15000, "user_cod_overdue_count": 2, "user_total_parcel_count": 5}
