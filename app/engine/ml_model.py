...
FEATURE_COLUMNS: list[str] = [
    ...
    "user_cancel_24h",
    "user_hospital_count",
    "user_claim_hospitals_1h",
    "user_claim_count",
    "user_claim_amount",
    "user_claim_30d_count",
    "user_claim_30d_amount",
    "user_rx_count",
    "user_drug_amount",
    "user_card_blacklist_hit",
    # 诊疗单据维度 (8)
    "order_total_amount",
    "order_item_count",
    "order_drug_quantity",
    "order_is_night",
    "order_doctor_rx_1d",
    "order_doctor_patient_1d",
    "order_diagnosis_same_7d",
    "order_receiver_not_self",
    # 医疗机构维度 (3)
    "addr_visit_count",
    "addr_is_new",
    "addr_cross_region",
...
if __name__ == "__main__":
    ...
    sample = {
        "user_total_visits": 3, "user_visits_7d": 1, "user_visits_30d": 2,
        "user_cancel_count": 0, "user_cancel_24h": 0, "user_hospital_count": 2,
        "user_claim_hospitals_1h": 0,
        "user_claim_count": 2, "user_claim_amount": 5000,
        "user_claim_30d_count": 1, "user_claim_30d_amount": 3000,
        "user_rx_count": 2, "user_drug_amount": 800, "user_card_blacklist_hit": 0,
        "order_total_amount": 1500, "order_item_count": 2, "order_drug_quantity": 30,
        "order_is_night": 0, "order_doctor_rx_1d": 5, "order_doctor_patient_1d": 4,
        "order_diagnosis_same_7d": 1, "order_receiver_not_self": 0,
        "addr_visit_count": 5, "addr_is_new": 0, "addr_cross_region": 0,
    }
    ...
    # 让 user_total_visits (FEATURE_COLUMNS[0]) 强相关 y, 方便看特征重要性
