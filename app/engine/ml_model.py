...
# 银行版 (2026-08-11 Task 3): 13 用户 + 9 事件 + 3 设备/IP, 跟 feature.py 的
# compute_user_features / compute_order_features / compute_address_features 一一对应.
# 对不齐会让 XGBoost 训练/推理退化成 0 填充, 业务上相当于模型没工作
FEATURE_COLUMNS: list[str] = [
    "user_total_applications",
    "user_applications_30d",
    "user_applications_60d",
    "user_avg_apply_amount",
    "user_max_apply_amount",
    "user_avg_debt_ratio",
    "user_overdue_plan_count",
    "user_overdue_24m_count",
    "user_hard_query_6m",
    "user_credit_score",
    "user_income_gap_ratio",
    ...
    "order_credit_score",
    "order_hard_query_6m",
    "order_five_level_risk",
    "order_income_verify_gap",
    "addr_device_share_count",
    "addr_device_age_days",
    "addr_ip_risk",
]
...
def train_and_save(
    ...
    if pos_ratio < settings.XGB_MIN_POS_RATIO:
        logger.warning(
            ...
            "  建议: python scripts/gen_bank_risk_events.py --good-rate 0.35 重新生成训练事件",
...
if __name__ == "__main__":
    ...
    sample = {
        "user_total_applications": 2, "user_applications_30d": 1, "user_applications_60d": 2,
        "user_avg_apply_amount": 150000, "user_max_apply_amount": 200000,
        "user_avg_debt_ratio": 0.35,
        "user_overdue_plan_count": 0, "user_overdue_24m_count": 0, "user_hard_query_6m": 2,
        "user_credit_score": 720, "user_income_gap_ratio": 0.05,
        "user_account_age_days": 400, "user_relation_count": 0,
        "order_amount": 150000, "order_term_months": 24, "order_dti": 0.35,
        "order_is_night": 0, "order_purpose_risk": 0, "order_credit_score": 720,
        "order_hard_query_6m": 2, "order_five_level_risk": 0, "order_income_verify_gap": 0.05,
        "addr_device_share_count": 1, "addr_device_age_days": 300, "addr_ip_risk": 0,
    }
    ...
    print("训练数据准备: python scripts/gen_bank_risk_events.py --all")
