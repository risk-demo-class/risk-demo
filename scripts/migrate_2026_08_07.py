...
ALTERS = [
    ...
    ("risk_case", "source_id",
     "VARCHAR(50) DEFAULT NULL COMMENT '原始业务ID(订货单/保修工单/举报单ID), 重做检查时用' AFTER risk_detail"),
    ("risk_case", "event_type",
     "ENUM('经销商订货', '采购订单', '保修申请', '售后维修', '串货举报') DEFAULT NULL COMMENT '触发案件的事件类型' AFTER source_id"),
]
