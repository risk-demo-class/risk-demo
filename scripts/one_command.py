...
【工作流 6 步】
  1. 重置数据库 (init_db.py --reset --yes, 含 30 条医疗规则)
  2. 造 30 个 RISK 高风险患者 (gen_risky_users.py --count 30)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="医疗风控系统 - 一条龙命令 (6 步: 重置 → RISK → 训练数据 → 训练 → 回填 → 启动)",
