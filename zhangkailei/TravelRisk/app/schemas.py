...
class RiskCheckRequest(BaseModel):
    """风险检查请求"""
    event_type: Literal["机票预订", "酒店预订", "签证申请", "订单支付"]
...
class RuleCreate(BaseModel):
    ...
    rule_category: Literal["票务欺诈", "支付风险", "账户风险", "签证风险", "身份风险", "行程风险"]
    event_type: Literal["机票预订", "酒店预订", "签证申请", "订单支付", "通用"] = "通用"
    rule_condition: dict
...
class RuleUpdate(BaseModel):
    ...
    rule_category: Optional[Literal["票务欺诈", "支付风险", "账户风险", "签证风险", "身份风险", "行程风险"]] = None
    event_type: Optional[Literal["机票预订", "酒店预订", "签证申请", "订单支付", "通用"]] = None
