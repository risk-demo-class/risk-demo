...
CREATE TABLE IF NOT EXISTS `risk_rule` (
    ...
    `rule_category` ENUM('票务欺诈','支付风险','账户风险','签证风险','身份风险','行程风险') NOT NULL COMMENT '风险场景分类',
    `event_type` ENUM('机票预订','酒店预订','签证申请','订单支付','通用') NOT NULL DEFAULT '通用' COMMENT '适用事件类型',
...
CREATE TABLE IF NOT EXISTS `risk_event` (
    ...
    `event_type` ENUM('机票预订','酒店预订','签证申请','订单支付') NOT NULL COMMENT '事件类型',
...
CREATE TABLE IF NOT EXISTS `risk_case` (
    ...
    `event_type` ENUM('机票预订','酒店预订','签证申请','订单支付') DEFAULT NULL COMMENT '触发案件的事件类型',
...
CREATE TABLE IF NOT EXISTS `risk_action_log` (
    ...
    `action_type` ENUM('CREATE_RULE','UPDATE_RULE','TOGGLE_RULE','DELETE_RULE','REVIEW_CASE','AUTO_REJECT_CASE','AUTO_CLOSE_CASE','ADD_BLACKLIST','REMOVE_BLACKLIST','BLACKLIST_HIT') NOT NULL COMMENT '操作类型',
