...
--   4. init_risk_data.sql        -- 31 条预置风控规则 (R001-R031)
--
-- ============================================
-- 使用方式
-- ============================================
...
--
-- 方式2: 手动按顺序执行 (在项目根目录下)
--   mysql -u root -p123321 --default-character-set=utf8mb4 BankRisk < sql/init_business_tables.sql
--   mysql -u root -p123321 --default-character-set=utf8mb4 BankRisk < sql/init_business_data.sql
--   mysql -u root -p123321 --default-character-set=utf8mb4 BankRisk < sql/init_risk_tables.sql
--   mysql -u root -p123321 --default-character-set=utf8mb4 BankRisk < sql/init_risk_data.sql
--
-- 方式3: 仅创建数据库结构 (不含数据)
--   mysql -u root -p123321 --default-character-set=utf8mb4 BankRisk < sql/init_business_tables.sql
--   mysql -u root -p123321 --default-character-set=utf8mb4 BankRisk < sql/init_risk_tables.sql
