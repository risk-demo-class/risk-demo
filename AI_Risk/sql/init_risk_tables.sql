...
CREATE TABLE IF NOT EXISTS `risk_rule` (
    ...
    `rule_category` VARCHAR(50) NOT NULL COMMENT '风险场景分类',
    `event_type` VARCHAR(50) NOT NULL DEFAULT '通用' COMMENT '适用事件类型',
...
CREATE TABLE IF NOT EXISTS `risk_case` (
    ...
    `event_type` VARCHAR(50) DEFAULT NULL COMMENT '触发案件的事件类型',
...
CREATE TABLE IF NOT EXISTS `risk_blacklist` (
    ...
    `blacklist_type` VARCHAR(50) NOT NULL COMMENT '黑名单类型',
...
CREATE TABLE IF NOT EXISTS `risk_alert` (
    ...
    `alert_type` VARCHAR(50) NOT NULL COMMENT '告警分类',
