...
class RiskCheckRequest(BaseModel):
    """风险检查请求"""
    event_type: Literal["注册/开户", "登录", "转账/支付", "贷款申请", "绑卡/换卡", "大额/可疑交易上报"]
...
class RiskCheckResponse(BaseModel):
    ...
    # 【P1-S9】被哪种黑名单撞了: None=没撞黑, "身份证"/"卡号"/"IP" 三选一.
...
class RuleCreate(BaseModel):
    ...
    rule_category: Literal["登录场景", "转账/支付场景", "贷款场景", "信用卡场景", "设备/网络环境", "账户行为"]
    event_type: Literal["注册/开户", "登录", "转账/支付", "贷款申请", "绑卡/换卡", "大额/可疑交易上报", "通用"] = "通用"
    rule_condition: dict
...
class RuleUpdate(BaseModel):
    ...
    rule_category: Optional[Literal["登录场景", "转账/支付场景", "贷款场景", "信用卡场景", "设备/网络环境", "账户行为"]] = None
    event_type: Optional[Literal["注册/开户", "登录", "转账/支付", "贷款申请", "绑卡/换卡", "大额/可疑交易上报", "通用"]] = None
...
class BlacklistCreate(BaseModel):
    """添加黑名单请求"""
    blacklist_type: Literal["身份证", "卡号", "IP", "设备指纹", "手机号", "企业信用代码"]
    blacklist_value: str
...
if __name__ == "__main__":
    ...
    req = RiskCheckRequest(
        event_type="开户", source_id="ord_demo_001", user_id="U0001",
    ...
    detail = AssessmentDetailResponse(
        assessment_id="ast_demo_xxx", event_id="evt_demo_xxx",
        user_id="U0001", event_type="开户", event_source_id="txn_demo_001",
