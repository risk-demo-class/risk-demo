...
class RiskEvent(Base):
    ...
    event_type: Mapped[str] = mapped_column(
        Enum("shipment_create", "shipment_cancel", "shipment_receive", "id_verification", name="event_type_enum"),
...
class RiskCase(Base):
    ...
    event_type: Mapped[Optional[str]] = mapped_column(
        Enum("shipment_create", "shipment_cancel", "shipment_receive", "id_verification", name="case_event_type_enum"),
        comment="触发案件的事件类型",
    )
    create_time: Mapped[Optional[datetime]] = mapped_column(
        DateTime, server_default=func.now(), default=datetime.now, comment="创建时间",
