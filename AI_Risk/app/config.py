...
# 银行工商风控: 黑名单类型集合 (6 种)
# 用于 risk_blacklist 表的 blacklist_type ENUM 值
# 身份证: 身份冒用/伪冒办卡; 卡号: 黑卡拦截(R030); IP: 代理IP/Tor/秒拨
# 设备指纹: 模拟器/多人共用; 手机号: 诈骗电话关联/断卡行动; 企业信用代码: 空壳/失信
BLACKLIST_TYPES = ("身份证", "卡号", "IP", "设备指纹", "手机号", "企业信用代码")

# 银行工商风控: 业务事件类型枚举 (6 种)
# E1开户/E2登录/E3转账/E4贷款申请/E5绑卡/E6大额上报
BUSINESS_EVENT_TYPES = ("注册/开户", "登录", "转账/支付", "贷款申请", "绑卡/换卡", "大额/可疑交易上报")
