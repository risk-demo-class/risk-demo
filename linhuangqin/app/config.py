...
class Settings(BaseSettings):
    ...
    DB_NAME: str = "ecs_logistics"
    TEST_DB_NAME: str = "ecs_logistics_test"
    ...
    # ---- 物流业务事件类型枚举 (三段式 10 类, 同步 schemas.py / models_risk.py) ----
    ...
    # ---- 黑名单 type 集合 (同步 risk_blacklist 的 blacklist_type ENUM) ----
