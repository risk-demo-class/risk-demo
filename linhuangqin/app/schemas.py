...
class RiskCheckRequest(BaseModel):
    """风险检查请求"""
    event_type: Literal["卖家下单寄件", "揽收入仓", "验货完成", "出仓发货", "运输中", "派送中", "买家签收", "买家拒收", "买家退回寄件", "退货入仓验货"]
...
class RuleCreate(BaseModel):
    ...
    rule_category: Literal["空包虚假发货", "物流调包", "验货质检", "退回假货", "恶意退货", "轨迹造假", "签收风险", "刷单刷信誉", "寄件信息异常", "费用争议"]
    event_type: Literal["卖家下单寄件", "揽收入仓", "验货完成", "出仓发货", "运输中", "派送中", "买家签收", "买家拒收", "买家退回寄件", "退货入仓验货", "通用"] = "通用"
    rule_condition: dict
...
class RuleUpdate(BaseModel):
    ...
    rule_category: Optional[Literal["空包虚假发货", "物流调包", "验货质检", "退回假货", "恶意退货", "轨迹造假", "签收风险", "刷单刷信誉", "寄件信息异常", "费用争议"]] = None
    event_type: Optional[Literal["卖家下单寄件", "揽收入仓", "验货完成", "出仓发货", "运输中", "派送中", "买家签收", "买家拒收", "买家退回寄件", "退货入仓验货", "通用"]] = None
