...
class RiskCheckRequest(BaseModel):
    """风险检查请求"""
    event_type: Literal["机票预订", "酒店预订", "签证申请", "跟团游报名", "退改申请"]
    source_id: str = Field(description="关联业务ID (order_id / visa_id)")
    user_id: str
...
class RuleCreate(BaseModel):
    ...
    event_type: Literal["机票预订", "酒店预订", "签证申请", "跟团游报名", "退改申请", "通用"] = "通用"
    rule_condition: dict
...
class RuleUpdate(BaseModel):
    ...
    event_type: Optional[Literal["机票预订", "酒店预订", "签证申请", "跟团游报名", "退改申请", "通用"]] = None
...
if __name__ == "__main__":
    ...
    req = RiskCheckRequest(
        event_type="机票预订", source_id="ord_demo_001", user_id="U0001",
    ...
    detail = AssessmentDetailResponse(
        assessment_id="ast_demo_xxx", event_id="evt_demo_xxx",
        user_id="U0001", event_type="机票预订", event_source_id="ord_demo_001",
