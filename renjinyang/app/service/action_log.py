...
if __name__ == "__main__":
    ...
    async def demo_record_action():
        ...
        await record_action(
            db, operator="admin", action_type="CREATE_RULE",  # type: ignore[arg-type]
        ...
        await record_action(
            db, operator="auditor1", action_type="REVIEW_CASE",  # type: ignore[arg-type]
        ...
        await record_action(
            db, operator="system", action_type="AUTO_REJECT_CASE",  # type: ignore[arg-type]
