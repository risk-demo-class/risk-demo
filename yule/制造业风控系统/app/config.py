"""
制造业风控系统 - 全局配置: 从 .env 文件加载, 支持环境变量覆盖.
"""
...
class Settings(BaseSettings):
    ...
    DB_NAME: str = "mfg_risk"
    TEST_DB_NAME: str = "mfg_risk_test"
...
# ============================================================
# 行业业务配置 (场景 D 制造业, 任务书要求放 config.py)
# ============================================================

# 业务事件类型枚举 (风控检查入口 / 规则适用事件 / 案件回溯共用)
BUSINESS_EVENT_TYPES: list[str] = ["经销商订货", "设备保修", "跨区串货举报"]

# 业务黑名单类型集合 (制造业: 经销商 / 设备SN / 维修工, 兼容通用 用户/手机号/地址)
BLACKLIST_TYPES: list[str] = ["用户", "经销商", "设备SN", "维修工", "手机号", "地址"]

# 规则风险分类 (制造业 6 大场景)
RULE_CATEGORIES: list[str] = ["订货风险", "保修风险", "串货风险", "资质风险", "维修风险", "账户风险"]
...
if __name__ == "__main__":
    print("=" * 60)
    print("制造业风控系统 - 全局配置 (从 .env 加载, 缺省值兜底)")
    print("=" * 60)
