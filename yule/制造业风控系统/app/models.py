...
包含 7 张业务表 + 9 张风控表的 SQLAlchemy 2.x 映射

业务表 (7): user_info / product / dealer_info / order_info
            / warranty_record / cross_region_report / blacklist_extra
风控表 (9): risk_rule / risk_event / risk_feature / risk_assessment
...
if __name__ == "__main__":
    print("=" * 60)
    print("ORM 模型总览 — 16 张表 (7 业务 + 9 风控)")
    print("=" * 60)
