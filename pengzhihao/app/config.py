...
# 对外使用物流术语；核心 9 张表的 ENUM 保持电商基线值不变。
...
CORE_EVENT_TO_LOGISTICS = {v: k for k, v in LOGISTICS_EVENT_TO_CORE.items()}
...
CORE_RULE_CATEGORY_TO_LOGISTICS = {
    v: k for k, v in LOGISTICS_RULE_CATEGORY_TO_CORE.items()
}
...
CORE_BLACKLIST_TYPE_TO_LABEL = {v: k for k, v in CORE_BLACKLIST_LABEL_TO_TYPE.items()}
EXTRA_BLACKLIST_TYPES = frozenset({"实名证件", "设备指纹", "IP地址", "海关主体"})
...
class Settings(BaseSettings):
    ...
    DB_NAME: str = "logistics_risk"
    TEST_DB_NAME: str = "logistics_risk_test"
