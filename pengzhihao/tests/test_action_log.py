...
class TestRuleRouterHook:
    ...
    async def test_create_rule_writes_log(self):
        ...
        data = RuleCreate(
            ...
            rule_category="行为异常", event_type="寄件受理",
...
class TestBlacklistHook:
    ...
    async def test_add_blacklist_writes_log(self):
        ...
        bl_new = SimpleNamespace(
            blacklist_id=10, blacklist_type="寄件人", blacklist_value="u1",
        ...
        request = BlacklistCreate(blacklist_type="寄件人", blacklist_value="u1", reason="test")
