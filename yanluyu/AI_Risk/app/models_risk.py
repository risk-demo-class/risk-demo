...
class RiskRule(Base):
    ...
    event_type: Mapped[str] = mapped_column(
        Enum("下单", "支付", "售后申请", "物流投诉", "报名", "退费申请", "打赏", "通用",
...
class RiskEvent(Base):
    ...
    event_type: Mapped[str] = mapped_column(
        Enum("下单", "支付", "售后申请", "物流投诉", "报名", "退费申请", "打赏",
...
class RiskFeature(Base):
    ...
    entity_type: Mapped[str] = mapped_column(
        Enum("用户", "订单", "地址", "课程", "设备", name="feature_entity_type_enum"),
...
class RiskBlacklist(Base):
    ...
    blacklist_type: Mapped[str] = mapped_column(
        Enum("用户", "地址", "手机号", "学号", "身份证号", "设备指纹", name="blacklist_type_enum"),
