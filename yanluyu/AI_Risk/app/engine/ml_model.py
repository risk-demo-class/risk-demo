...
FEATURE_COLUMNS: list[str] = [
    # 用户维度 (6)
    "user_total_orders",
    "user_order_amount_1h",
    "user_refund_count_90d",
    "user_refund_amount_90d",
    "user_days_since_register",
    "user_is_teacher",
    # 订单维度 (3)
    "order_total_amount",
    "course_is_student_only",
    "device_linked_students",
    # 课程维度 (1)
    "course_new_students_7d",
    # 学习维度 (1)
    "study_minutes_before_refund",
    # 打赏维度 (1)
    "donation_amount",
]

assert len(FEATURE_COLUMNS) == 12, f"教育特征数量必须是 12, 当前 {len(FEATURE_COLUMNS)}"
