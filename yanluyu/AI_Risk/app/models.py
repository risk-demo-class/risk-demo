...
包含 7 张教育业务表 + 9 张风控表的 SQLAlchemy 2.x 映射
"""

# 教育业务表 (7 张)
from app.models_edu import (
    BlacklistExtra,
    Course,
    DonationRecord,
    LearningProgress,
...
__all__ = [
    # 教育业务表 (7)
    "UserInfo", "Course", "OrderInfo", "LearningProgress",
    "RefundRequest", "BlacklistExtra", "DonationRecord",
...
if __name__ == "__main__":
    print("=" * 60)
    print("ORM 模型总览 — 16 张表 (7 教育业务 + 9 风控)")
    print("=" * 60)
