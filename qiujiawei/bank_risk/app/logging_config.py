...
# bank_risk/app/logging_config.py → bank_risk/logs/
...
def build_logging_config(log_file: str = APP_LOG_FILE, level: str = "INFO") -> dict:
    ...
    return {
        ...
        "loggers": {
            ...
            # 业务 logger (bank_risk.app.*) 走 root 配置, 不用单独配
            # 例: bank_risk.app.engine.decision → logger = logging.getLogger(__name__)
        },
        "root": {
            "handlers": ["console", "file"],
            "level": level,
...
# ============================================================
# Demo: 看一眼日志配置 — 跑法: python -m bank_risk.app.logging_config
# ============================================================
if __name__ == "__main__":
    print("=" * 60)
    print("bank_risk 日志配置")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("使用:")
    print("  1. 启动服务: python -m bank_risk.scripts.main   (uvicorn 用本配置)")
