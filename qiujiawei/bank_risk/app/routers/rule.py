...
from bank_risk.app.schemas import RuleCreate, RuleListResponse, RuleResponse, RuleUpdate
from bank_risk.app.service.action_log import orm_to_dict, record_action
...
async def api_list_rules(
    ...
    """分页列出规则 (对齐 assessments/cases 的 {items, total} 模式)."""
    # 1 次 COUNT
