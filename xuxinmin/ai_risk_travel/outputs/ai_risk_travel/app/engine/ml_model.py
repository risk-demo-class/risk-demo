"""
旅游风控系统 - XGBoost 模型管理: 加载 / 推理 / 训练 / 兜底.
...
# 旅游行业 25 维: 用户 14 + 订单 7 + 乘客 4
# 改这个列表前必须同步: feature.py::compute_user_features / compute_order_features
# / compute_passenger_features / tests/test_xgboost.py::test_feature_columns_align
...
if __name__ == "__main__":
    ...
    sample = {
        ...
        "user_total_amount": 15000, "user_avg_order_amount": 5000.0,
        "user_max_order_amount": 8000,
        "user_refund_count": 0, "user_refund_rate": 0.0,
        "user_complaint_count": 0, "user_address_count": 1,
        "user_visa_reject_count_90d": 0, "user_visa_countries_30d": 1,
        "user_real_name_status": 1, "user_account_age_days": 365,
        "order_total_amount": 8000, "order_passenger_count": 2,
        "order_trip_days": 5, "order_is_night": 0, "order_is_urgent": 1,
        "order_dest_country_count": 1, "order_flight_count": 1,
        "pax_id_consistency": 1.0, "pax_blacklist_hits": 0,
        "pax_foreign_nationality_count": 0, "pax_avg_age": 30,
    }
