...
from app.config import BlacklistType, BusinessEventType
...
class RiskCheckRequest(BaseModel):
    ...
    source_id: str = Field(description="关联业务ID（课程订单/退费申请/学习进度ID）")
    user_id: str
...
class RuleCreate(BaseModel):
    ...
    rule_category: Literal["课程报名", "课程退费", "身份异常", "设备异常", "综合风险"]
    event_type: BusinessEventType | Literal["通用"] = "通用"
    rule_condition: dict
...
class RuleUpdate(BaseModel):
    ...
    rule_category: Optional[Literal["课程报名", "课程退费", "身份异常", "设备异常", "综合风险"]] = None
    event_type: Optional[BusinessEventType | Literal["通用"]] = None
...
if __name__ == "__main__":
    ...
    req = RiskCheckRequest(
        event_type="COURSE_PURCHASE", source_id="ord_demo_001", user_id="U0001",
        event_data={"amount": 5000, "course_category": "人工智能"},
    )
    ...
    hits = [
        RuleHitInfo(
            rule_id="R002", rule_name="0学时退费",
            rule_category="课程退费", risk_level="高",
            risk_score=75, action="人工审核",
            description="退款前学习不足5分钟且退款金额大于0",
        ),
        RuleHitInfo(
            rule_id="R008", rule_name="同设备关联多个学员",
            rule_category="设备异常", risk_level="极高",
    ...
    resp = RiskCheckResponse(
        ...
        features={"device_distinct_users_30d": 6, "order_total_amount": 6999},
    ...
    detail = AssessmentDetailResponse(
        assessment_id="ast_demo_xxx", event_id="evt_demo_xxx",
        user_id="U0001", event_type="COURSE_PURCHASE", event_source_id="ord_demo_001",
